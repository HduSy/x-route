...
export const translations = {
    en: {
        ...
        sharedRouteImported: 'Imported shared route: {name}',
        shareLinkBroken: 'Shared link is invalid or corrupted',
        delete: 'Delete',
        basemap: 'Basemap',
        distance: 'Distance',
        ascent: 'Ascent',
        ...
        cyclewayRoute: 'Cycle paths (cycleway)',
        tertiaryRoute: 'Tertiary roads (quiet backroads)',
        routePreference: 'Route preference',
        elevationPreferenceTitle: 'Elevation preference',
        ...
        manualModeDesc: 'New points connect to the route end with straight lines; existing segments keep their road path',
        returnToStart: 'Return to start',
        returnToStartDesc: 'Retrace the route in reverse from the end back to the start, forming a round trip',
        returnToStartNeedPoints: 'Add at least 2 points first',
        returnToStartAlreadyLoop: 'Already a closed loop (start and end are within 50 m)',
        ...
        confirmClearTitle: 'Clear Current Route?',
        confirmClearBody: 'This will remove all placed waypoints and the current unsaved route. Start over?',
        confirm: 'Clear Route',
        confirmDeleteRouteTitle: 'Delete Route?',
        confirmDeleteRouteBody: 'Are you sure you want to permanently delete "{name}"? This action cannot be undone.',
    ...
    zh: {
        ...
        sharedRouteImported: '已导入分享路线：{name}',
        shareLinkBroken: '分享链接无效或已损坏',
        delete: '删除',
        basemap: '底图',
        distance: '距离',
        ascent: '累计爬升',
        ...
        cyclewayRoute: '优先自行车道 (绿道/专用道)',
        tertiaryRoute: '优先乡村与支路 (避开主干道)',
        routePreference: '路线偏好',
        elevationPreferenceTitle: '爬升偏好',
        ...
        manualMode: '自由画线模式',
        manualModeDesc: '新增的点与当前末点直线直连，不吸附路网；已有路段保持原轨迹不变',
        returnToStart: '原路返回',
        returnToStartDesc: '从终点沿原路逆序折返至起点，补全为往返闭环',
        returnToStartNeedPoints: '请先添加至少 2 个点',
        returnToStartAlreadyLoop: '已是闭环（起终点相距不足 50 米）',
        mapDisplay: '地图显示选项',
        surfaceType: '路面比例',
        surfaceBreakdown: '路面材质占比',
        unpaved: '非铺装 / 砂石',
        unknownSurface: '未知路面',
        ...
        confirmClearTitle: '清空当前规划？',
        confirmClearBody: '当前绘制的节点与未保存规划将被清除，是否重新开始绘制？',
        confirm: '确认清空',
        confirmDeleteRouteTitle: '删除路线？',
        confirmDeleteRouteBody: '确定要永久删除路线 “{name}” 吗？此操作无法撤销。',
        confirmDelete: '确认删除',
        updateRoute: '更新路线',
